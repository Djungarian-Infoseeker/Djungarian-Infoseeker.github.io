...
<body>
    ...
    <p>
      最后，我们使用一维气候模型研究了 Kepler-186f 的宜居性。其表面温度可以在 CO<sub>2</sub> 压力为 0.5–5 巴（取决于 N<sub>2</sub> 的含量）时升高至 273 K 以上。Kepler-186f 作为一颗处于冷星宜居带较冷区域的地球大小行星，为我们提供了一个重要的研究案例。
    </p>
    ...
    <ol>
      <li>内向迁移的行星胚胎群体通过碰撞生长（Terquem & Papaloizou 2007；Cossou 等, 2014）；</li>
      <li>近距离行星胚胎的原位吸积（Raymond 等, 2008；Chiang & Laughlin 2013）。</li>
    </ol>
    <p>
  ...
  <h2>图 3. 地球型行星吸积模拟的演化</h2>
  <div class="figure">
    <img src="https://content.cld.iop.org/journals/0004-637X/793/1/3/revision1/apj499317f3_lr.jpg" alt="图 3. 地球型行星吸积模拟演化">
    <div class="caption">
      每个圆圈对应一个生长中的行星胚胎或微行星，其半径满足 $$R\\propto M^{0.27}$$ （Valencia 等, 2006，x 轴不按比例显示）。最终行星的质量在最后一幅图中标出。<br>
      下载图像：<a href="#">标准图像</a> | <a href="#">高清图像</a>
    </div>
  </div>
  
  <h2>图 4. 行星质量与轨道半径分布</h2>
  <p>
  ...
  <div class="figure">
    <img src="https://content.cld.iop.org/journals/0004-637X/793/1/3/revision1/apj499317f4_lr.jpg" alt="图 4. 行星质量与轨道半径分布">
    <div class="caption">
      图 4. 开普勒-186 系统的行星尺寸与轨道半径（大黑方块）与不同盘性质下 N 体模拟结果（各种符号）的比较。<br>
      下载图像：<a href="#">标准图像</a> | <a href="#">高清图像</a>
    </div>
  </div>
  <p>
  ...
  <div class="figure">
    <img src="https://content.cld.iop.org/journals/0004-637X/793/1/3/revision1/apj499317f5_lr.jpg" alt="图 5. 系统相对倾角">
    <div class="caption">
      图 5. 模拟系统中相对于 Kepler-186f 类比行星的相对倾角。为了使行星 f 类比行星位于正确的轨道距离，图中对轨道半径进行了缩放。实际行星位置（参数集未特别指明）以灰色符号显示。<br>
      下载图像：<a href="#">标准图像</a> | <a href="#">高清图像</a>
    </div>
  </div>
  <p>
