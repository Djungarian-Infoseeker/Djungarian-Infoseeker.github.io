...
在夏令营正式开始前几天，学院会通过邮件发送心理测试的相关链接。这些测试旨在辅助学院更全面地了解学生的性格特点和心理状态，并提升人才选拔效率。以下是相关内容和注意事项。
...
需要特别说明的是，这两个测试的效力是否完全适用于科研选拔尚不明确，但可能具有以下参考意义：

- **MBTI** 测试旨在评估学生的性格类型，例如决策方式和信息处理偏好，潜在用于分析学生是否适合科研工作。
- **MMPI** 测试则主要聚焦于学生的精神健康状态，可能用于判断是否存在影响科研工作的心理问题，以及是否对研究机构构成安全隐患。

尽管测试结果不计入正式成绩，但可能会在面试中引发与测试相关的提问，建议同学们认真对待。
